...
(function () {
  ...
  function generateFullReviewsDataset() {
    ...
    // Reference anchor date: Aug 31, 2026 (shifted by +200 days)
    const baseTimestamp = new Date('2026-08-31T12:00:00Z').getTime();
