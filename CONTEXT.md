...
- Brand truth from docs: Miroooo is a precise, calm, quietly premium UK oral-care storefront for `Miroooo X` and `Miroooo X2`; tone should be natural UK English, assured, restrained, and non-medical.
...
- Header behavior: announcement bar says `Free tracked UK delivery` and `90-day home trial`; desktop nav includes Shop, Miroooo X2, Contact, FAQ, Track order, and bag icon; mobile nav opens a full overlay panel and supports Escape/resize close handling.
