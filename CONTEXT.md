...
- Current `Brush X` offer details observed: primary visible price `GBP 59`, compare price `GBP 119`, product ID for Buudy checkout `1000000664011633`, color variants Pink `1000020348812111`, Grey `1000020348812113`, Silver `1000020348812112`, checkout source `miroooo`.
...
- Current `Brush X2` offer details observed: primary visible price `GBP 79`, compare price `GBP 159`, product ID for Buudy checkout `1000000664011618`, effective variant IDs from `VARIANTS_DATA` Pink `1000020348810062`, Grey `1000020348810048`, Silver `1000020348810046`, checkout source `miroooo-x2`.
