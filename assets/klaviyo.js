(function () {
  ...
  var PRODUCTS = {
    "miroooo-x": {
      ...
      ImageURL: "https://trymiroooo.com/assets_ref/x/gallery/Miroooo_x_Pink-1.webp",
      URL: "https://trymiroooo.com/products/miroooo-x",
      Brand: "MIROOOO",
      Price: 69,
      CompareAtPrice: 139
    },
    "miroooo-x2": {
      ...
      SKU: "MIROOOO-X2",
      Categories: ["Electric Toothbrushes", "Oral Care"],
      ImageURL: "https://trymiroooo.com/assets_ref/x2/gallery/miroooo-x2-sonic-electric-toothbrush-silver-checkout.webp",
      URL: "https://trymiroooo.com/products/miroooo-x2",
      Brand: "MIROOOO",
      Price: 69,
      CompareAtPrice: 139
    },
    "miroooo-x2-heads": {
      ...
      ImageURL: "https://trymiroooo.com/assets_ref/x2/heads/B1.webp",
      URL: "https://trymiroooo.com/products/miroooo-x2-heads",
      Brand: "MIROOOO",
      Price: 15,
      CompareAtPrice: 30
    }
  ...
  function handleAddedToCart(event) {
    ...
    track("Added to Cart", {
      ...
      CheckoutURL: "https://trymiroooo.com/cart",
      Items: [item],
      Currency: CURRENCY,
      Market: MARKET,
      SourceSite: SOURCE_SITE
  ...
  function handleStartedCheckout(event) {
    ...
    track("Started Checkout", {
      ...
      CheckoutURL: checkoutUrl || "https://trymiroooo.com/cart",
