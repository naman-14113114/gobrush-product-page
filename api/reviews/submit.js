...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const productName = isX2 ? "Miroooo X2 Flagship" : "Miroooo X1 Sonic";
    ...
    try {
      const emailPayload = {
        ...
        subject: `[New Customer Review] ${rating}★ for ${isX2 ? "Miroooo X2" : "Miroooo X1"} - "${title || name}"`,
    ...
    const updatedContent = `// Standalone Organic Customer Submissions for ${isX2 ? "Miroooo X2" : "Miroooo X1"} (Not rendered on storefront)
